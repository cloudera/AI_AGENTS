...
from .tools import (
    ...
    API_Specification_directory_lister,
)
    ...
    def __init__(self, configuration: Initialize) -> None:
        ...
        self.metadata_summarizer_agent = Agent(
            ...
            goal=dedent(
                ...
                If you find that any directory or file you need is missing, that means that the API_Specification_splitter 
                tool has not been run. In that case, delegate the task to the API Specification splitter agent, 
            ...
            backstory="You are an expert in analysing API Specification JSON files and summarising the API capabilities.",
            verbose=True,
